...
import com.ls.netty.project1.server.codec.*;
import com.ls.netty.project1.server.handler.AuthHandler;
...
import com.ls.netty.project1.server.handler.ServerIdleCheckHandler;
...
public class Server2 {
    public static void main(String[] args) throws InterruptedException, ExecutionException, CertificateException, SSLException {
        ...
        serverBootstrap.option(NioChannelOption.SO_BACKLOG, 1024);//添加接收等待队列大小
        serverBootstrap.childOption(NioChannelOption.TCP_NODELAY, true);
        serverBootstrap.handler(new LoggingHandler(LogLevel.INFO));

        //thread   完善线程名称前缀，便于排查问题
        ...
        try{
            ...
            serverBootstrap.childHandler(new ChannelInitializer<NioSocketChannel>() {
                ...
                protected void initChannel(NioSocketChannel ch) throws Exception {
                    ...
                    pipeline.addLast("ipFilter", ruleBasedIpFilter);//IP黑白名单设置
                    ...
                    pipeline.addLast("ssl", sslContext.newHandler(ch.alloc()));//创建ssl的handler
                    ...
                    pipeline.addLast("auth", authHandler);//自定义授权，主要放置的位置
